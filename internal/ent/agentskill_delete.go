...
func (_d *AgentSkillDelete) Where(ps ...predicate.AgentSkill) *AgentSkillDelete {
...
func (_d *AgentSkillDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(agentskill.Table, sqlgraph.NewFieldSpec(agentskill.FieldID, field.TypeInt))
...
// Where appends a list predicates to the AgentSkillDelete builder.
func (_d *AgentSkillDeleteOne) Where(ps ...predicate.AgentSkill) *AgentSkillDeleteOne {
...
func (_d *AgentSkillDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{agentskill.Label}
	default:
		return nil
	}
}
